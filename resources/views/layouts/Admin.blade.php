...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Catagory Section</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="/admin/EmployeCatagory">Add Employe Catagory</a></li>
         ...
         <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>Salary Section</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="/admin/AddSalary">Add Salary(Monthly)</a></li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="/admin/ViewAllAttendance">View All Attendance</a></li>
          </ul>
        </li>


         <li class="treeview">
          <a href="#"><i class="fa fa-link"></i> <span>communicate Employe</span>
            <span class="pull-right-container">
                <i class="fa fa-angle-left pull-right"></i>
              </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="/admin/SendWorkTask">Send Work Task(Individual)</a></li>
            <li><a href="/admin/SendWorkTaskMultiple">Send Work Task(Multiple)</a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2016 <a href="#"> Saha</a> </strong> All rights reserved.
  </footer>
